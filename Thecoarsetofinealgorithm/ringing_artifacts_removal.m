function [result] = ringing_artifacts_removal(y, kernel, lambda_tv, lambda_l0, weight_ring, exemplar, weight_exemplar)
%%
...
elseif nargin == 7
    Latent_l0 = L0Restoration(y_pad, kernel, lambda_l0, 2, exemplar, weight_exemplar);
end
